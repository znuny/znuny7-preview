...
$Selenium->RunTest(
    sub {
        ...
        my $OTRSBusiness            = $Kernel::OM->Get('Kernel::System::OTRSBusiness');
        my $OTRSBusinessIsInstalled = $OTRSBusiness->OTRSBusinessIsInstalled();
        ...
        if ($OTRSBusinessIsInstalled) {
            ...
            my $NonAddNoteArticleID = $ArticleBackendPhoneObject->ArticleCreate(
                TicketID             => $TicketID,
                IsVisibleForCustomer => 1,
                SenderType           => 'agent',
